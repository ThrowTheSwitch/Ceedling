...
See [_CeedlingCustomPlugins_][custom-plugins] for documentation of the test results data structure (i.e. the `results` method arguments in above sample code).
...
[custom-plugins]: ../docs/CeedlingCustomPlugins.md
