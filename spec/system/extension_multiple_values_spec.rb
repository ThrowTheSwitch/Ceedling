...
ceedling_system_tests do
  include_context "a fresh ceedling gem project", "multi_ext_asm"
  ...
  describe "Deployed as a gem" do
    ...
    # =========================================================================
      ...
      before do
        in_project do
          copy_fixture("tests_with_multiple_assembly_extensions/src/counter_module.h", 'src')
          copy_fixture("tests_with_multiple_assembly_extensions/src/counter_module.c", 'src')
          copy_fixture("tests_with_multiple_assembly_extensions/src/asm_helper_lower.s", 'src')
          copy_fixture("tests_with_multiple_assembly_extensions/src/asm_helper_upper.S", 'src')
          copy_fixture("tests_with_multiple_assembly_extensions/test/test_counter_module.c", 'test')
        end
      end
