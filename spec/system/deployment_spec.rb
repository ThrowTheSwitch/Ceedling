...
describe "Ceedling" do
  ...
  describe "deployed in a project's `vendor` directory." do
    ...
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_without_regex_pattern_set }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_line_number_regex_set }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_test_name_regex_set }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_test_name_and_line_regex_set }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_regex_node_without_test_name_and_line_no }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_without_regex_pattern_set_and_cmd_args_set_to_true }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_line_number_regex_set_and_cmd_args_set_to_true }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_test_name_regex_set_and_cmd_args_set_to_true }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_test_name_and_line_regex_set_and_cmd_args_set_to_true }
    it { test_run_of_projects_fail_because_of_sigsegv_with_report_using_valgrind_as_debugger_with_regex_node_without_test_name_and_line_no_and_cmd_args_set_to_true }
