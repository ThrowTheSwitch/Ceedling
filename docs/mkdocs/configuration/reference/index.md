...
-   :material-book-open-variant: **[`:project` — Global Project Settings][ref-project]**
...
-   :material-book-open-variant: **[`:mixins` — Mixins][ref-mixins]**
...
-   :material-book-open-variant: **[`:test_build` — Test Build Settings][ref-test-build]**
...
-   :material-book-open-variant: **[`:environment` — Environment Variables][ref-environment]**
...
-   :material-book-open-variant: **[`:paths` — Search Paths][ref-paths]**
...
-   :material-book-open-variant: **[`:files` — File Collections][ref-files]**
...
-   :material-book-open-variant: **[`:extension` — File Extensions][ref-extension]**
...
-   :material-book-open-variant: **[`:defines` — Compilation Symbols][ref-defines]**
...
-   :material-book-open-variant: **[`:flags` — Compilation & Link Flags][ref-flags]**
...
-   :material-book-open-variant: **[`:libraries` — Libraries][ref-libraries]**
...
-   :material-book-open-variant: **[`:unity` — Unity][ref-unity]**
...
-   :material-book-open-variant: **[`:cmock` — CMock][ref-cmock]**
...
-   :material-book-open-variant: **[`:cexception` — CException][ref-cexception]**

    ---

    Compile-time symbol definitions to configure CException's behavior.

-   :material-book-open-variant: **[`:test_runner` — Test Runner Generation][ref-test-runner]**
...
-   :material-book-open-variant: **[`:tools` — Command Line Tools][ref-tools]**
...
-   :material-book-open-variant: **[`:plugins` — Ceedling Extensions][ref-plugins]**
